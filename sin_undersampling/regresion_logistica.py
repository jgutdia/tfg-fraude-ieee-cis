...
GRID_UMBRAL      = np.arange(0.01, 0.51, 0.01)
...
def paso_5_umbral(modelo, X_train_std, y_train, cv, etiqueta):
    encabezado(f"PASO 5 - Umbral óptimo para {etiqueta} (maximiza F1 en CV)")
    ...
    info(f"Umbral óptimo: {umbral_opt:.2f}  |  F1 en ese umbral: {f1s[idx]:.4f}")
